...
import { logo } from '/src/assets/assets.js'
        ...
        <>
            ...
            <div className='mt-10 flex gap-8 flex-col md:flex-row md:item-end'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='mt-1'>
                        <img className='inline-block w-5' src={logo.bbcircle} alt="" />
                        <b>BeatBliss</b>
                        • 1,220,266 likes
                        • <b>50 Songs,</b>
                        about 2 ht 30 min
            ...
            <div className='grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7]'>
                ...
                <img className='m-auto w-4' src={assets.clock_icon} alt="" style={{filter:'contrast(0.001)'}} />
            </div>
            <hr />
            {
